...
├──────────────────────────────┼──────────────────────────────────────────┼──────────────┼─────────────────────────────────────┼──────────────────────────┤
│ `test_uart_basic`            │ Basic UART communication test            │ ✅ Complete  │ UART TX/RX, SPI init                │ UART 通信 (つうしん)       │
...
├──────────────────────┼──────────────────────────────────────────┼──────────────────┼─────────────────────────────────────────┤
│ Embedded C/C++       │ Modular driver, register-level access    │ ⭐⭐⭐⭐⭐          │ 組込 C/C++ (くみこみ しーぷらすぷらす)    │
...
│ Debugging            │ Logic Analyzer integration, EFLG mon.    │ ⭐⭐⭐⭐⭐          │ デバッグ技術 (でばっぐ ぎじゅつ)          │
│ Documentation        │ Professional report generator, SOP       │ ⭐⭐⭐⭐⭐          │ 技術文書 (ぎじゅつ ぶんしょ)              │
